...
export default function Home() {
  return (
    <>
      ...
      {/* Opaque and above the sticky hero, so it slides over it on scroll. */}
      <main className="relative z-10 bg-paper">
        <div className="mx-auto w-full max-w-[600px] px-6 pt-16 pb-18">
              ...
              <li key={post.href} className="mb-5">
                ...
                >
                  <Image
                    ...
                    width={1200}
                    height={800}
                    // The top card is the largest thing in this section; don't defer it.
                    priority={i === 0}
...
/** The thin double hairline under the section eyebrow. */
function DoubleRule() {
  return (
    <div
      aria-hidden
